...
# Split train+val into train and validation (60/20 overall)
...
X_trainval = scaler.fit_transform(X_trainval)  # For retraining later
...
def train_and_evaluate_deep(hparams, device='cpu', patience=20):
    """
    Trains the deep network using the provided hyperparameters.
...
# -----------------------------
# 9. Evaluate Final Deep Model on Test Set
# -----------------------------
